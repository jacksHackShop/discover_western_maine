...
*/
    ...
    if (!class_exists('DOPBSPBackEndCalendarSchedule')){
		...
		global $DOT;
                ...
                $calendar_id = !empty($args) ? $args['calendar_id']:$_POST['id'];
                $year = !empty($args) ? $args['year']:$_POST['year'];
                $firstYear = !empty($args) ? $args['firstYear']:$_POST['firstYear'];
...
//                }
		...
		global $DOT;
                ...
                $default_availability = $_POST['default_availability'];
