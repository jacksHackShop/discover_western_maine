 ...
 */
		...
		if ($location == 'get'){
		    return isset($_GET[$variable]) ? trim($_GET[$variable]):false;
		}
		else{
		    return $DOT->classes->permalink->verify($variable, $redirect);
		}
            }
	     ...
	     *	    -
            ...
            public function post($variable){
                return isset($_POST[$variable]) ? trim($_POST[$variable]):false;
            }
