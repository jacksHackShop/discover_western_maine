...
function init_maps(){
  ...
  jQuery('.gmap_listing_explorer_wrapper').each( build_map_listing_explorer.bind(site_wide_map_style), function(){
    jQuery('a.gmap_directions_link_wrapper').each( build_directions_link_map.bind(site_wide_map_style) );} );
}

var build_directions_link_map = function( map_style ){
  var $dom_element = jQuery(this);
